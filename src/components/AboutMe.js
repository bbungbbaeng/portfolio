    ...
    return (
        <div className="aboutme-view">
            ...
            <div className="text-box1">
                ...
                <span className="text2">I love playful, even seemingly pointless things, <br/>and I’m passionate about development driven by design.</span>
            </div>
            <div className="text-box2">
                <span className="text1">Values</span>
                <span className="text2">I place great importance on attending to every little detail in my designs.</span>
            </div>
            <div className="text-box3">
                <span className="text1">Strengths</span>
                <span className="text2">I’m meticulous and deliberate in everything I do.</span>
            </div>
            <div className="text-box4">
                <span className="text1">Education</span>
                <span className="text2">Division of Economics, Hankuk University of Foreign Studies.</span>
            </div>
